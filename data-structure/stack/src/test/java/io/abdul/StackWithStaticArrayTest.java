...
class StackWithStaticArrayTest {

    @Test
    void push() throws NoSuchFieldException, IllegalAccessException {
        Stack<Integer> numberStack = new StackWithStaticArray<>(5);
        ...
        assertThrows(StackOverflow.class, () -> numberStack.push(0));
    }
    ...
    void isFull() {
        ...
        assertFalse(numberStack.isFull());
        numberStack.push(5);
        assertFalse(numberStack.isFull());
        numberStack.push(4);
        assertFalse(numberStack.isFull());
