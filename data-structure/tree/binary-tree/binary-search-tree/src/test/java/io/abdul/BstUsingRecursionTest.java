...
class BstUsingRecursionTest {
    ...
    @Test
    void lookup() {
        BstUsingRecursion<String> stringTree = new BstUsingRecursion<>();
    ...
    private static void testInteger() {
        BstUsingRecursion<Integer> integerTree = new BstUsingRecursion<>();
    ...
    private void testRemovingNonRootNodeWithTwoChildrenAndSuccessorIsFarFromNodeAndSuccessorIsHavingOneChild() throws NoSuchFieldException, IllegalAccessException, IOException {
        BstUsingRecursion<Integer> numbers = new BstUsingRecursion<>();
        numbers.insert(100);
        numbers.insert(9);
        numbers.insert(105);
        numbers.insert(7);
    ...
    private <E extends Comparable<E>> void removeAndTest(BstUsingRecursion<E> numbers, String inputFilePath,
        ...
        BstUsingRecursion.Node<E> rootNode;
    ...
    private void testRemovingLeftParentWithTwoChildren(BstUsingRecursion<String> stringTree) throws NoSuchFieldException, IOException, IllegalAccessException {
        stringTree.empty();
    ...
    private void testRemovingRootWithTwoChildren(BstUsingRecursion<String> stringTree) throws NoSuchFieldException, IOException, IllegalAccessException {
        stringTree.empty();
    ...
    private void testRemovingParentNodeWithOnlyOneChildOnTheRight(BstUsingRecursion<String> stringTree) throws NoSuchFieldException, IOException, IllegalAccessException {
        stringTree.empty();
    ...
    private void testRemovingParentNodeWithOnlyOneChildOnTheLeft(BstUsingRecursion<String> stringTree) throws NoSuchFieldException, IOException, IllegalAccessException {
        stringTree.empty();
    ...
    private void testRemovingLeafNodeWhichIsOnTheLeftOfParent(BstUsingRecursion<String> stringTree) throws NoSuchFieldException, IllegalAccessException, IOException {
        stringTree.empty();
    ...
    private void testRemovingLeafNodeWhichIsOnTheRightOfParent(BstUsingRecursion<String> stringTree) throws NoSuchFieldException, IllegalAccessException, IOException {
        stringTree.empty();
    ...
    private void testRemovingRootNodeWithOnlyOneChildOnTheRight(BstUsingRecursion<String> stringTree) throws NoSuchFieldException, IllegalAccessException, IOException {
        stringTree.empty();
    ...
    private void print(BstUsingRecursion<String> stringTree) throws NoSuchFieldException, IllegalAccessException, JsonProcessingException {
        BstUsingRecursion.Node<String> rootNode = getRootNode(stringTree);
        System.out.println(objectMapper.writeValueAsString(rootNode));
    }

    private void testRemovingRootNodeWithOnlyOneChildOnTheLeft(BstUsingRecursion<String> stringTree) throws NoSuchFieldException, IOException, IllegalAccessException {
        stringTree.empty();
    ...
    private void testRemovingOnlyElementInTheTree(BstUsingRecursion<String> stringTree) throws IOException, NoSuchFieldException, IllegalAccessException {
        stringTree.empty();
    ...
    private static <E extends Comparable<E>> BstUsingRecursion.Node<E> getRootNode(BstUsingRecursion<E> numbers) throws NoSuchFieldException, IllegalAccessException {
        Field elementsField = numbers.getClass().getDeclaredField("root");
        elementsField.setAccessible(true);
        return (BstUsingRecursion.Node<E>) elementsField.get(numbers);
    }
