...
class Main {
    ...
    public static void knightTour(int[][] visited, int x, int y, int pos, AtomicInteger size) {
...
//            print(visited);
        ...
        for (int k = 0; k < 8; k++) {
            ...
            if (isValid(newX, newY) && visited[newX][newY] == 0) {
                knightTour(visited, newX, newY, pos + 1, size);
            }
        }
    ...
    public static void main(String[] args) {
        ...
        knightTour(visited, 0, 0, pos, size);
