package io.abdul.recursion.practice.problem30;
...
public class MagnetPuzzleII {
    public static void main(String[] args) {
        System.out.println(Solution.solveMagnetPuzzleV2(new char[][]{{'L', 'R'}, {'L', 'R'}},
                new int[]{1, -1}, new int[]{-1, -1}, new int[]{-1, -1}, new int[]{1, -1}));
        System.out.println(Solution.solveMagnetPuzzleV2(new char[][]{
                {'L', 'R', 'L', 'R', 'T', 'T'},
                {'L', 'R', 'L', 'R', 'B', 'B'},
                {'T', 'T', 'T', 'T', 'L', 'R'},
                {'B', 'B', 'B', 'B', 'T', 'T'},
 ...
 */
class Solution {
    public static List<String> solveMagnetPuzzleV2(char[][] rules, int[] top, int[] bottom,
                                                   int[] left, int[] right) {
        ...
        solveMagnetPuzzleV2(rules, top, bottom, left, right,
    ...
    private static void solveMagnetPuzzleV2(char[][] rules, int[] top, int[] bottom,
                                            int[] left, int[] right, int[] cTop, int[] cBottom,
                                            int[] cLeft, int[] cRight, List<String> result,
                                            char[][] puzzle, int row, int column) {

        if (row >= left.length) {
            if (rulesMet(top, left, right, bottom, cTop, cBottom, cLeft, cRight)) {
                result.add(Arrays.deepToString(puzzle));
            }
            return;
        }
        ...
        if (rules[row][column] == 'L') {
            if (canPlaceLeftRight(puzzle, row, column, '+', '-')) {
                ...
                cRight[row]++;
                cBottom[column + 1]++;
                solveMagnetPuzzleV2(rules, top, bottom, left, right, cTop, cBottom, cLeft, cRight, result, puzzle, nextRow, nextColumn);
                puzzle[row][column] = 'x';
