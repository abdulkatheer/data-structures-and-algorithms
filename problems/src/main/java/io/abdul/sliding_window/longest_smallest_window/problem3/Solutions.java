...
//        Solution2 solution = new Solution2();
        ...
        assertEquals(73, solution.totalFruits(new int[]{44, 44, 22, 22, 44, 22, 44, 22, 22, 22, 22, 44, 22, 22, 44, 22, 22, 44, 22, 22, 22, 22, 44, 44, 44, 44, 44, 44, 22, 22, 22, 44, 44, 22, 44, 22, 22, 22, 22, 44, 44, 44, 44, 22, 22, 44, 44, 22, 22, 44, 22, 22, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 22, 22, 44, 44, 44, 22, 22, 22, 22, 44, 44}));
...
class Solution2 {
    public int totalFruits(int[] fruits) {
        ...
        while (right < n) {
             ...
             */
            if (fruitsHarvested.size() > 2) {
                while (fruitsHarvested.size() > 2) {
                    fruitsHarvested.put(fruits[left], fruitsHarvested.get(fruits[left]) - 1);
                    if (fruitsHarvested.get(fruits[left]) == 0) { // one type is completely removed, end up having just two types now
